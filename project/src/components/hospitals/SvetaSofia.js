...
import picture from '../../pictures/sveta_sofia.png'
    ...
    function update(){
     ...
     const bookBed = (event) => {
        ...
        return (
            <div>
            <Container>
            <h1 className="shadow-sm text-success mt-5 p-3 text-center rounded">St. Sophia Medical Center</h1>
            <Row>
            <Col>
