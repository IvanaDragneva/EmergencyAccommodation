...
import picture from '../../pictures/SecondHospital.png'
import Image from 'react-bootstrap/Image'
import axios from 'axios';
import CommentForm from '../CommentForm'

function WtoraBolnica(){
    ...
    function update(){
     ...
     const bookBed = (event) => {
        ...
        return (
            <div>
            <Container>
            <h1 className="shadow-sm text-success mt-5 p-3 text-center rounded">Second Multiprofile Hospital for Active Treatment - EAD, Sofia</h1>
            <Row>
            <Col>
                    
                <ul>
                    <li><b>Description:</b> Second Hospital performs high-quality consulting and diagnostic activities and hospital treatment. The team of the hospital always strives to implement innovative methods and technologies for diagnosis and treatment. Their main priority is to maintain the position of the hospital as a leading medical institution in the field of cardiology and obstetrics and gynecology.</li>
